# 000083-Book-store-Decouple-order-process-with-SQS-and-SNS

## Book store Decouple order process with SQS and SNS

AWS Workshop: **Book store Decouple order process with SQS and SNS**
